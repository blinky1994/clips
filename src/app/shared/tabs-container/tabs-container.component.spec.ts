...
describe('TabsContainerComponent', () => {
  ...
  it('should have two tabs', () => {
    ...
    fixture.debugElement.query(By.directive(TabsContainerComponent));
    const tabsProps = containerComponent.componentInstance.tabs;

    expect(tabs.length)
    .withContext('Tabs did not render').toBe(2);

    expect(tabsProps.length)
    .withContext('Could not grab component property').toBe(2);
  });
});
